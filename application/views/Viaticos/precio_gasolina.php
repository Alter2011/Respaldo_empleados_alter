...
<form>
    <div class="modal fade" id="Modal_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h3 class="modal-title" id="exampleModalLabel"><center>Editar precio de combustible</center></h3>
            ...
            <div class="modal-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    <input type="text" name="precio_edit" id="precio_edit" class="form-control" placeholder="Precio ">
                  </div>
              </div>
            ...
            <button type="button" type="submit" id="btn_save" class="btn btn-primary" data-backdrop="false" onclick="editar_gasolina()">Guardar</button>
...
<form>
    <div class="modal fade" id="Modal_moto_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLabel"><center>Editar motocicleta</center></h3>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="modelo_edit" id="modelo_edit" class="form-control" placeholder="Modelo">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="consumo_edit" id="consumo_edit" class="form-control" placeholder="Consumo km/gal">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label">Precio:</label>
                    <div class="col-md-10">
                        <input type="text" name="precio_moto_edit" id="precio_moto_edit" class="form-control" placeholder="Precio">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="llantas_del_edit" id="llantas_del_edit" class="form-control" placeholder="llantas delanteras">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="llantas_tra_edit" id="llantas_tra_edit" class="form-control" placeholder="llantas traceras">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="mant_b_edit" id="mant_b_edit" class="form-control" placeholder="Mant. Base">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="mant_m_edit" id="mant_m_edit" class="form-control" placeholder="Mant. mayor">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="anio_edit" id="anio_edit" class="form-control" placeholder="T. vida (años)">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="km_edit" id="km_edit" class="form-control" placeholder="T. vida (años)">
                    </div>
                </div>
            ...
            <button type="button" type="submit" id="btn_save" class="btn btn-primary" data-backdrop="false" onclick="editar_motocicleta()">Guardar</button>
...
<!-- MODAL EDIT -->
<form>
    <div class="modal fade" id="Modal_depreciacion_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLabel"><center>Editar depreciación</center></h3>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <input type="hidden" name="codigo_depreciacion" id="codigo_depreciacion" class="form-control" readonly>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="number" name="meses_edit" id="meses_edit" class="form-control" placeholder="Meses">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="mensual_edit" id="mensual_edit" class="form-control" placeholder="Mensual">
                    </div>
                </div>
            ...
            <button type="button" type="submit" id="btn_save" class="btn btn-primary" data-backdrop="false" onclick="editar_depreciacion()">Guardar</button>
