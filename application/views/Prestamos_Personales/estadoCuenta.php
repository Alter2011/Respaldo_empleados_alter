<div class="col-sm-10" id="impresion_boleta">
            <div class="text-center well text-white blue" id="boletas">
                <h2>Estado de Cuenta de Prestamo Personal</h2>
                    ...
                    <div class="well" id="mostrar">
                        <table class="table table-bordered" id="tabla_boleta">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>$<?php echo($personal[0]->cantidad);?></td>
                              <td>$<?php echo($personal[0]->couta);?></td>
                              <td><?php echo($personal[0]->fecha_otorgado);?></td>
                              <td><?php echo($personal[0]->nombre_tipos);?></td>
                              <td><?php echo($personal[0]->plazo_quincenas);?></td>
                              <td><?php echo($personal[0]->descripcion_prestamo);?></td>
                            </tr>
                          </tbody>
                        </table>
                        ...
                        <?php
                          foreach ($amortizaciones as $key){
                            if(!($key->estado == 2 && $key->planilla == 1)){
                        ?>
                            <tr>
                                ...
                                <td><?php echo(number_format($key->interes_pendiente,2));?></td>
