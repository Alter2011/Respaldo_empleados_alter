...
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>
   ...
   <form action="<?php echo base_url("index.php/Seguimiento/ReporteRC_agencias"); ?>" method="POST">
               ...
               <?php  for ($k=1; $k <= count($regiones) ; $k++) {  
                        ...
                        <tbody>
                            ...
                            $totCar=0;//total 
                             ...
                             $totPA=0;//total cartera anterior anterior
                             $TcontIMP=0;
                            ...
                            <tr class="table-light">
                                ...
                                <td> <?=(number_format(abs($stotNuC), 2, '.', ',')) ; ?> </td>
                    ...
                    ?>  
                          ...
                          <tr class="table-light">
                                ...
                                <td> <?=(number_format(abs($totNuC), 2, '.', ',')) ; ?> </td>
