    ...
    <div class="col-sm-10" id="buscador">
        <div class="col-sm-12">
           ...
           <div class="form-group col-sm-3">
            ...
            <div class="form-group col-sm-3">
                <button class="btn btn-success crear" id="btn_imprimir" style="position: relative; top: 25px; display: none;">Imprimir</button>
           </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function imprimir_datos(mes=null,quincena=null){
            ...
            $.ajax({
                type  : 'POST',
                url   : '<?php if ($boletas=="personal"){echo site_url("Boleta_pago/imprimir_boleta");}else if($boletas=="todos"){echo site_url("Boleta_pago/traer_boletas");}?>',
                dataType : 'JSON',
                ...
                //$('#nombre').text(data.nombre);
                    ...
                    //se limpian los arrays para que cuando se genere nuevamente una boleta
                    mostrar_banco[i]='';
                    espacio=[];
                    mostrar_prestamo[i]='';
                    aux[i]='';
                    ...
                    if (isss==0 && afp_ipsfa==0) {
                        total_devengado= parseFloat(total_devengado).toFixed(2);
                    }else{
                        total_devengado= parseFloat(total_devengado)+parseFloat(comision) +parseFloat(bono)+parseFloat(horas_extras)+parseFloat(viaticos);
                        total_devengado=total_devengado.toFixed(2);
                    }

                    //MOSTRAR EL MENSAJE DE SUBSIDIO DEL GOBIERNO
                    if (data.boleta[j].mes=="2020-11") {
                        tiempo="Primera entrega del subsidio del Gobierno";
                    }else if(data.boleta[j].mes=="2020-12"){
                        tiempo="Segunda entrega del subsidio del Gobierno";
                    }
                    ...
                    if (isss==0  && afp_ipsfa==0) {
                        //CREACION DEL ENCABEZADO DE LAS BOLETAS CON LOGO DEL GOBIERNO
                        ...
                        '</div> <div style="margin: 12px;text-align: center;" > <b style="font-size:16.5px">Subsidio para la Recuperación de las Empresas Salvadoreñas en Cumplimiento<br>  a la ley de Protección del Empleo Salvadoreño otorgado por el Gobierno de El Salvador. <br> '+decre+' '+tiempo+' </b> </div>'+
                            ...
                            '<div class="row" style="margin: 5px;text-align: center">'+
                                ...
                                '<div class="col-sm-6" style="border:1px solid">'+
                                    ...
                                    '<div class="col-sm-12 prueba" id="mostrar_herramientas'+j+'" style="">'+
                                        ...
                                        '</div>'+
                                    '</div>'+
                                    //fin de descuento de herramientas
                                    '</div>'+
                                    //faltantes
                                    '<div class="row" style="margin: 5px;text-align: left;">'+
