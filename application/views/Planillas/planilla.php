        ...
        <div class="container col-sm-12 col-xs-12 print-col-sm-12" id="imprimir">
            ...
            <div class="row">
                <div class=" col-sm-12 col-md-12 " id="tabla" style="font-size:13px">
                    <table style="font-size:13px; border-collapse: collapse" class="table"  id="myTable">
                        <thead class="text-center">
                            <tr >
                                <!-- NO10012023 cambio para la vista de la tabla -->
                              ...
                              <th rowspan="4"><strong>Total Pagar</strong></th>   
                            </tr>
                            <tr>
