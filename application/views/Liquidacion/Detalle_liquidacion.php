...
<div class="col-sm-10" id="impresion_boleta">
            ...
            <?php }else if($liquidacion[0]->estado == 0){?>
              ...
              <?php if($aprobar == 1){ ?>
              <a class="btn btn-default" data-toggle="modal" data-target="#Modal_editar" id="btn_permiso"><span class="glyphicon glyphicon-pencil"></span> Editar Artículo</a>
              <?php } ?>
            ...
            <?php } ?>
                ...
                <div class="col-sm-12">
                  ...
                  <?php } ?>
                    ...
                    <div style="margin: 10px;" class="contenedor">
                      <p class="text-justify"><?php echo $liquidacion[0]->descripcion ?></p>
                    </div><br>
                  ...
                  <div class="contenedor">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4"><b style="text-decoration: underline;">DATOS GENERALES</b></div>
                    </div>
                    <div class="row">
                      <div class="col-sm-1"><b></b></div>
                    ...
                    <!--<div class="row">
                      ...
                      <div class="col-sm-2"><span><?php echo $liquidacion[0]->dias_ano; ?> DIAS</span></div>
                      <div class="col-sm-4"><b></b></div>
                    </div>-->
                    ...
                    if($liquidacion[0]->fecha_inicio > (substr($liquidacion[0]->fecha_fin, 0,4).'-01-01')){
                      $fecha_indemni = $liquidacion[0]->fecha_inicio;
                    }else{
                      $fecha_indemni = (substr($liquidacion[0]->fecha_fin, 0,4).'-01-01');
                    }
                      $difInd = date_diff(date_create($fecha_indemni),date_create($liquidacion[0]->fecha_fin));
                      ...
                      if($diasInd == 365){
                        ...
                        $ind = 'INDEMNIZACION PROPORCIONAL';
                        $subInd = 'Proporcionalidad';
                      }
                    ...
                    <div class="row">
                      <div class="col-sm-1"><b></b></div>
                      <div class="col-sm-4"><b style="text-decoration: underline;"><?php echo $i.' )'.$ind; ?></b></div>
                    ...
                    <div class="row">
                      <div class="col-sm-1"><b></b></div>
                      <div class="col-sm-4">
                        <b>del <?php echo date_format(date_create($fecha_indemni),'d/m/Y'); ?> al <?php echo date_format(date_create($liquidacion[0]->fecha_fin),'d/m/Y') ?></b>
                      </div>
                    </div>
                    
                    <div class="row">
                      <div class="col-sm-1"><b></b></div>
                      <div class="col-sm-4">  <?= $subInd ?> a <?= $diasInd ?> dias</div>
                        <div class="col-sm-4"><b></b></div>
                    </div><br>
                    <?php $i++;
                    } ?>
                    ...
                    <?php if($liquidacion[0]->pago_dias > 0){ ?>
                    <div class="row">
                      <div class="col-sm-1"><b></b></div>
                    ...
                    <div style="text-align: center;">
                      <div class="row">
                        <div class="col-sm-6"><span><?= $liquidacion[0]->agencia ?>, <?php if($liquidacion[0]->fecha_generada!=null){echo $liquidacion[0]->fecha_generada;}else{echo date("j")." de ". meses(date('m'))." de ".date("Y");}?></span></div>
                      </div>
                    </div>
                    <div style="text-align: center; padding-top: 10%;" id="prueba">
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6" style="position:relative;top: -120px;"><img src="<?= $firma;?>" id="img_vacacion" style="width:160px; "><br><?= $nombre_auto; ?><br><?= $cargo_auto;?></div>
                      </div>
                ...
                <?php if($estadoR == 1){ ?>
                  ...
                  <?php }else if($estadoR == 2){ ?>
                    <h4 class="text-center"><b>CANCELACION DE DEUDA</b></h4><br>
                    <h5 class="text-justify texto_finiquito" style="line-height: 1.5;">
                    Por medio de la presente se hace constar que el señor(a): <b class="negrita"><?php echo $liquidacion[0]->nombre.' '.$liquidacion[0]->apellido ?></b>, da por finalizado una deuda por <b class="negrita"> <?php echo $deuda.' ($'.number_format($totalDes,2).')'; ?></b> con la empresa <b class="negrita"><?php echo $liquidacion[0]->nombre_empresa ?></b> cancelándolo en su totalidad el día <?php if($liquidacion[0]->fecha_generada!=null){echo $liquidacion[0]->fecha_generada;}else{echo date("j")." de ". meses(date('m'))." de ".date("Y");}?> según los siguientes conceptos:
                    <br><br>
                  <?php } ?>
                ...
                if($descuentos != null){
                  for($i = 0; $i < count($descuentos); $i++){ ?>
                    <div class="row">
                      <div class="col-sm-1"><b></b></div>
                      <div class="col-sm-5"><b class="negrita">- <?php echo $descuentos[$i]['tipoD']; ?></b></div>
                      <div class="col-sm-1" style="text-align: right;"><b class="negrita">$</b></div>
                      <div class="col-sm-2" style="text-align: right;"><span class="texto_deuda"><?php echo number_format($descuentos[$i]['pagoD'],2); ?></span></div>
                    </div>
                <?php 
                    }
                  }
                ...
                <?php if($faltante > 0){ ?>
                 <div class="row">
                    <div class="col-sm-1"><b></b></div>
                    <div class="col-sm-5"><b class="negrita">- Faltante</b></div>
                    <div class="col-sm-1" style="text-align: right;"><b class="negrita">$</b></div>
                    <div class="col-sm-2" style="text-align: right;"><span class="texto_deuda"><?php echo number_format($faltante,2); ?></span></div>
                  </div>
                <?php } ?>
                <?php if($anticipo > 0){ ?>
                 <div class="row">
                    <div class="col-sm-1"><b></b></div>
                    <div class="col-sm-5"><b class="negrita">- Anticipo</b></div>
                    <div class="col-sm-1" style="text-align: right;"><b class="negrita">$</b></div>
                    <div class="col-sm-2" style="text-align: right;"><span class="texto_deuda"><?php echo number_format($anticipo,2); ?></span></div>
                  </div>
                <?php } ?>
                <?php if($Personal > 0){ ?>
                 <div class="row">
                    <div class="col-sm-1"><b></b></div>
                    <div class="col-sm-5"><b class="negrita">- Prestamo Personal</b></div>
                    <div class="col-sm-1" style="text-align: right;"><b class="negrita">$</b></div>
                    <div class="col-sm-2" style="text-align: right;"><span class="texto_deuda"><?php echo number_format($Personal,2); ?></span></div>
                  </div>
                <?php } ?>
                <div class="row">
                  <div class="col-sm-2"><b></b></div>
                  <div class="col-sm-4"><b></b></div>
                  <div class="col-sm-1 bonde" style="text-align: right;"><b class="negrita">$</b></div>
                  <div class="col-sm-2 bonde" style="text-align: right;"><span class="texto_deuda"><?php echo number_format($totalDes,2); ?></span></div>
                </div><br><br>
                <?php if($estadoR == 1){ ?>
                ...
                <br><br>
                  ...
                  <?php }else if($estadoR == 2){ ?>
                    Y para los usos que se estime conveniente se extiende la presente en la ciudad de <?= $liquidacion[0]->agencia ?>, <?php if($liquidacion[0]->fecha_generada!=null){echo $liquidacion[0]->fecha_generada;}else{echo date("j")." de ". meses(date('m'))." de ".date("Y");}?>
                  <?php } ?>
               <br><br><br>
                </h5>
                <div style="text-align: center; margin-top: 6em;" id="prueba">
                  <div class="row">
                    <div class="col-sm-3"><span></span></div>
                    <div class="col-sm-6"><img src="<?= $firma;?>" style="width:240px;position:relative;top: -50px; "><br><?= $nombre_auto; ?><br><?= $cargo_auto;?></div>
                  </div>
                  </div>
                  </div>
                <br><br>
                ...
                <div class="col-sm-12">
                 ...
                 <?php }else if($liquidacion[1]->tipo_des_ren == 5 && $liquidacion[1]->dias_laborado < 200){ ?>
                  ...
                  <div class="contenedor">
                    ...
                    <?php
                    $diferencia = date_diff(date_create($liquidacion[1]->fecha_quin2),date_create($liquidacion[1]->fecha_quin1));
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-2">$ <?php echo number_format($dias) ?></div>
                    </div>
                    <div class="row">
                      <div class="col-sm-1"><b></b></div>
                      <div class="col-sm-4">SUELDO DIARIO</div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body"> 
            <blockquote contenteditable="true">
                <p id="texto_edicion"><?php echo $liquidacion[0]->descripcion ?></p>
            </blockquote>  
          </div>
          <div class="modal-footer">
            <input type="hidden" name="id_liq_edit" id="id_liq_edit" class="form-control" readonly value="<?= ($liquidacion[0]->id_liquidacion);?>">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
            <button type="button" id="btn_edicion" class="btn btn-danger">Aceptar</button>
        </div>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        //Metodo para la edicion del articulo 
        $('#btn_edicion').on('click',function(){
            var texto_edicion = $('#texto_edicion').html();
            var id_liq_edit = $('#id_liq_edit').val();

            $.ajax({
              type : "POST",
              url  : "<?php echo site_url('Liquidacion/editarArticulo')?>",
              dataType : "JSON",
              data : {id_liq_edit:id_liq_edit,texto_edicion:texto_edicion},
              success: function(data){
                Swal.fire(
