            ...
            <div class="text-center well text-white blue" id="boletas">
                ...
                <div class="col-sm-12">
                    <div class="well" id="mostrar">
                          ...
                          <tbody>
                            <tr>
                              <td colspan="2"><?php echo($antiguo[0]->fecha_solicitud);?></td>
                              <td colspan="4"><?php echo($antiguo[0]->nombre);?> <?php echo($antiguo[0]->apellido);?></td>
                              <td colspan="2"><?php echo($antiguo[0]->codigo_empleado);?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                             ...
                             <tr>
                              <td><b>Agencia:</b></td>
                              <td colspan="3"><?php echo($antiguo[0]->agencia);?></td>
                              <td><b>Area:</b></td>
                              <td colspan="3"><?php echo($antiguo[0]->area);?></td>
                            </tr>
                            <tr>
                              <td><b>Puesto:</b></td>
                              <td colspan="3"><?php echo($antiguo[0]->cargo);?></td>
                              <td colspan="4"></td>
                            </tr>
                            <tr>
                              <td colspan="4">&nbsp;</td>
                            ...
                            <tr>
                                <input type="hidden" name="tramite" id="tramite" class="form-control" placeholder="Product Code" readonly value="<?php echo($antiguo[0]->tipo_permiso);?>">
                                <td colspan="2">
                            ...
                            <tr>    
                                ...
                                <td>    
                                    <label class="checkbox-inline" id="vacaciones">
                                        <input type="checkbox" id="check8" class="check_imprimir" disabled>Vacaciones
                                    </label>
                                </td>
                                <td>    
                            ...
                            <tr>
                                ...
                                <td><?php echo(substr($antiguo[0]->desde,8,2));?></td>
                                <td><?php echo(substr($antiguo[0]->desde,5,2));?></td>
                                <td><?php echo(substr($antiguo[0]->desde,0,4));?></td>

                                <td rowspan="2"><b>Hasta</b></td>
                                <td><?php echo(substr($antiguo[0]->hasta,8,2));?></td>
                                <td><?php echo(substr($antiguo[0]->hasta,5,2));?></td>
                                <td><?php echo(substr($antiguo[0]->hasta,0,4));?></td>
                            </tr>
                            <tr>
                                <td><b>Dia</b></td>
                                <td><b>Mes</b></td>
                            ...
                            <tr>
                             ...
                             <tr>
                                <td colspan="8"><?php echo($antiguo[0]->Justificacion);?></td>
                            </tr>
