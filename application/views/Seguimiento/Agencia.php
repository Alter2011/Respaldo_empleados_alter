...
<div class="col-sm-10 col-xs-12 print-col-sm-10" id="imprimir">
    <div class="text-center well text-white blue no-print">
        <h2>Seguimiento Agencia: <?= $agencia;?></h2>
                ...
                <div class="row">
                        ...
                        <div class="panel panel-primary ">
                            <div class="panel-heading"><label style="margin-right: 70%">Colocacion por monto</label>  <label>Mes: <?= $MesActual;?>  </label>
                                ...
                                if ($this->uri->segment(4)==""){
                                    ...
                                    $link = $segmento."/Now/".$this->uri->segment(5);
                                    
                                }else{
                                    
                                    $link = str_pad($this->uri->segment(4), 2, "0", STR_PAD_LEFT)."/".$this->uri->segment(3)."/".$this->uri->segment(5);
                                    
                                }
                                ?>
                                    <a target="_blank" href="<?php echo site_url(); ?>/seguimiento/Comparacion/Carteras/<?= $link?>"> 
                            ...
                            <div class="panel-body">
                                <table class="table table-hover">
                                    <thead>
                                        ...
                                        <th scope="col">Semana 4</th>
                                        <th scope="col">Acumulado</th>
                                        <th scope="col">Acumulado Total</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                    ...
                    <div class="panel-group col-sm-4">
                        <div class="panel panel-success ">
                            ...
                            <div class="panel-body">
                                <?php if (isset($conta[$Agencias->id_cartera])){ ?>
                                     <?php if (($conta[$Agencias->id_cartera])==0){ ?>
                                      <h5 class="alert alert-danger text-center">
                                        <strong class="text-center">Cartera no ingresada</strong>
                                </h5>
                                <?php }else{
                                  ?>
                                    <h5 class="alert alert-info text-center">
                                        <strong class="text-center">Cartera ingresada </strong>
                                </h5>
                                  <?php
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
   ...
   // document.ready = document.getElementById("datepicker").value = 'Seleccione una fecha';
        ...
        $("#nap").change(function () {
                    date= $("#nap").val();
         window.location.href = "<?php echo site_url() ?>/Seguimiento/fecha_agencias/"+date+'/'+<?php echo $segmento ?>;
