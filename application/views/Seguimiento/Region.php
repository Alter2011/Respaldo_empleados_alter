...
<div class="col-sm-10 col-xs-12 print-col-sm-10" id="imprimir">
    <div class="text-center well text-white blue no-print">
        <h2>Seguimiento Region #<?= $this->uri->segment(5)?></h2>
...
$( function() {
    ...
    <?php for ($i=0; $i < count($fechas_cartera); $i++) { 
        ...
        $anio=substr($fechas_cartera[$i]->fecha, 0,4);
         $mes2=substr($fechas_cartera[$i]->fecha, 5,2);
            ...
            <div class="well col-sm-12 col-xs-12 print-col-md-10">   
                ...
                <div class="panel-group col-sm-12">
                    <div class="panel panel-primary ">
                        <div class="panel-heading"><label style="margin-right: 70%">Colocacion por monto</label>  <label>Mes: <?= $MesActual;?>  </label>
                            <label>
                            <?php
                            
                            if ($this->uri->segment(4)=="0"){
                                
                                $link = $this->uri->segment(3)."/Now/".$this->uri->segment(5);
                                
                            }else{
                                
                                $link = $this->uri->segment(4)."/".$this->uri->segment(3)."/".$this->uri->segment(5);
                                
                            }
                            ?>
                                <a target="_blank" href="<?php echo site_url(); ?>/seguimiento/Comparacion/Agencias/<?= $link?>"> 
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <th scope="row">Desembolso</th>
                                            ...
                                            <td><?= number_format($totalcolocado=$acumcolocado+$Acolocado,2)?></td>
                                        </tr>
                                        <tr>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <th scope="row">Ppto. Colocacion</th>
                                            ...
                                            <td> <?= number_format($Semana4Ppto['Sabado']+$Semana4Ppto['Lunes']+$Semana4Ppto['Martes']+$Semana4Ppto['Miercoles']+$Semana4Ppto['Jueves']+$Semana4Ppto['Viernes'],2) ?> </td>
                                        </tr>
                                        <tr>
                                        <th scope="row">Factibilidad (A Desembolsar)</th>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?=$ConteoSe14?></td>
                                            <td><?=$ConteoSe15?></td>
                                            <td><?=$ConteoSe11+$ConteoSe12+$ConteoSe13+$ConteoSe14+$ConteoSe15?></td>
                                            <td><?=$ConteoSe11+$ConteoSe12+$ConteoSe13+$ConteoSe14+$ConteoSe15+count($ProspectosAnterior)?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <td><?= count($ProspectadoAnterior) ?></td>
                                            ...
                                            <td><?=$ConteoSe21+$ConteoSe22+$ConteoSe23+$ConteoSe24+$ConteoSe25+count($ProspectadoAnterior)?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <td><?= count($ClienteAnterior) ?></td>
                                            ...
                                            <td><?=$ConteoSe34?></td>
                                            <td><?=$ConteoSe35?></td>
                                            <td><?=$ConteoSe31+$ConteoSe32+$ConteoSe33+$ConteoSe34+$ConteoSe35?></td>
                                            <td><?=$ConteoSe31+$ConteoSe32+$ConteoSe33+$ConteoSe34+$ConteoSe35+count($ClienteAnterior)?></td>
                                        </tr>
                                        ...
                                        <td><?= @number_format(count($ClienteAnterior)/count($ProspectadoAnterior)*100,2) ?>%</td>
                                            ...
                                            <td><?= @number_format(($ConteoSe31+$ConteoSe32+$ConteoSe33+$ConteoSe34+count($ClienteAnterior))/($ConteoSe21+$ConteoSe22+$ConteoSe23+$ConteoSe24+$ConteoSe25+count($ProspectadoAnterior))*100,2)?>%</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="panel-group col-sm-4">
                        <div class="panel panel-success ">
                            ...
                            <label>Agencia: <?php if ($Agencias->id_cartera==14) {echo "Ateos";
                                # code...
                            }elseif($Agencias->id_cartera=='09') {
                                echo "Quezaltepeque";
                            }else{echo $Agencias->agencia ;}   ?></label>
                            <a href="<?php echo site_url(); ?>/Seguimiento/Agencia/<?=$Agencias->id_cartera?>" class="close" > <span aria-hidden="true"><i class="fa fa-cog"></i></span><span class="sr-only">Ver Mas</span></a>
                            </div>
                            <div class="panel-body">
                                <h5 class="alert alert-info text-center">
                                        <strong class="text-center">Carteras ingresadas</strong>
                                       
                                        <span class="badge"><?=$contadorCarteras[$Agencias->id_cartera]  ?></span>/<span class="badge"><?= @$carteraTotal[$Agencias->id_cartera] ?></span>
                                </h5>
                            </div>
                            <div class="panel-footer">
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    ...
    var anio = f.getFullYear();
       function load() {
              $.ajax({
                type : "POST",
                url  : "<?php echo site_url('seguimiento/Region')?>",
                dataType : "JSON",
                data : {  valor:valor},
     ...
     /* $(document).ready(function(){
            ...
            if (valor<=9) {document.ready = document.getElementById("nap").value = anio+'-0'+valor;
            } else {
     ...
     $("#nap").change(function () {
       ...
       <?php if ($segmento=='CM01') { ?> 
         window.location.href = "<?php echo site_url() ?>/Seguimiento/fecha_region/"+date+'/CM01/<?= $this->uri->segment(5)?>';
        <?php }elseif ($segmento=='JB02') { ?>
         window.location.href = "<?php echo site_url() ?>/Seguimiento/fecha_region/"+date+'/JB02/<?= $this->uri->segment(5)?>';

        <?php }elseif ($segmento=='MG03') { ?>
         window.location.href = "<?php echo site_url() ?>/Seguimiento/fecha_region/"+date+'/MG03/<?= $this->uri->segment(5)?>';
