                    ...
                    <div class="panel-group col-sm-12">
                        <div class="panel panel-primary ">
                            <div class="panel-heading">
                                <label style="margin-right: 70%">Nivel Region #<?=$this->uri->segment(6)?></label>  <label>Mes: <?= $General['MesActual'];?>  </label>
                ...
                <!-- Inicia Region-->
                    <div class="panel-group col-sm-12">
                        <div class="panel panel-info ">
                            <div class="panel-heading">
                                <label style="margin-right: 70%"><?= $retval =($codigo == 14) ? "Ateos" : $key->agencia;?></label>  <label>Mes: <?= $General['MesActual'];?>   </label>
                            ...
                            <div class="panel-body table-responsive">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#home<?= $key->id_agencia;?>">Home</a></li>
